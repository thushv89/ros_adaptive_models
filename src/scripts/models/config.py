...
if USE_CONV_STRIDE_WITHOUT_POOLING:
    ...
    TF_ANG_STRIDES = {'conv1': [1, 1, 1, 1], 'conv2': [1, 1, 2, 1], 'conv3': [1, 2, 2, 1], 'conv4': [1, 2, 2, 1],
                      'conv5': [1, 1, 1, 1]}
else:
...
if USE_CONV_STRIDE_WITHOUT_POOLING:
    ...
    TF_ANG_VAR_SHAPES_NAIVE = {'conv1': [4, 8, 3, 32], 'pool1':[1,4,8,1], 'conv2': [5, 5, 32, 48], 'pool2':[1,3,3,1],
